...
const DiceBoard = () => {
  return (
    <section className="flex justify-center mt-32 bg-green-700 w-[500px] px-6 pb-6 pt-28  m-auto rounded-2xl border-4 border-stone-950 shadow-lg shadow-stone-900">
      <button>
